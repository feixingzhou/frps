...
安装
```shell
wget https://raw.githubusercontent.com/feixingzhou/frps/master/frps_linux_install.sh && chmod +x frps_linux_install.sh && ./frps_linux_install.sh
# 以下为国内镜像
wget https://github.ioiox.com/feixingzhou/frps/raw/branch/master/frps_linux_install.sh && chmod +x frps_linux_install.sh && ./frps_linux_install.sh
```
...
卸载
```shell
wget https://raw.githubusercontent.com/feixingzhou/frps/master/frps_linux_uninstall.sh && chmod +x frps_linux_uninstall.sh && ./frps_linux_uninstall.sh
# 以下为国内镜像
wget https://github.ioiox.com/feixingzhou/frps/raw/branch/master/frps_linux_uninstall.sh && chmod +x frps_linux_uninstall.sh && ./frps_linux_uninstall.sh
```
...
#### 修改 frps_linux_install.sh 脚本
`FRP_VERSION=0.58.1` 可根据原版项目更新自行修改为最新版本.  
...
```shell
git clone https://github.com/feixingzhou/frps
# git clone 本仓库
git clone https://github.ioiox.com/feixingzhou/frps
# 国内镜像
